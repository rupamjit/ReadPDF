...
const ChatWrapper = ({ fileId }: ChatWrapperProps) => {
  ...
  if (isLoading)
    return (
      <div className="relative min-h-full bg-zinc-50 flex divide-y divide-zinc-200 flex-col justify-between gap-2">
        <div className="flex-1 flex justify-center items-center flex-col mv-28">
  ...
  return (
    <div className="relative min-h-full bg-iznc-50 flex divide-y divide-zinc-200 flex-col justify-between gap-2">
